      ...
      <div class="p-fluid">
        <div v-if="status === 'pending'">
          <Message severity="info" :closable="false"
            >Resetting your password, please wait...</Message
          >
        </div>
        ...
        <div v-else-if="status === 'invalid'">
          <Message severity="error" :closable="false"
            >This password reset link is invalid or has expired.</Message
          >
        </div>
          ...
          <form @submit.prevent="handleReset">
            <div class="field">
              ...
              <div v-if="fieldErrors.password">
                <div
                  v-for="(m, i) in fieldErrors.password"
                  :key="i"
                  class="p-error"
            ...
            <div class="field">
              ...
              <div v-if="fieldErrors.password2">
                <div
                  v-for="(m, i) in fieldErrors.password2"
                  :key="i"
                  class="p-error"
                  style="margin-top: 6px"
                >
              ...
              <div
                v-if="password && password2 && password !== password2"
                class="p-error"
                style="margin-top: 6px"
              >
            ...
            <Message
              v-if="fieldErrors._non_field && fieldErrors._non_field.length"
              severity="error"
              :closable="false"
            >
...
const handleReset = async () => {
  ...
  try {
    ...
    if (success) {
      ...
      fieldErrors.value =
        storeError?.fields || parseApiErrorFields(storeError?.details || storeError);
    }
  } catch (e) {
