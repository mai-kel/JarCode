<template>
          ...
          <form @submit.prevent="handleRegister">
            <div class="p-fluid">
              ...
              <div class="field">
                ...
                <small v-if="fieldErrors.password2" class="p-error">{{
  ...
  <Card v-else>
    <template #title> Account created </template>
    <template #content>
...
const handleRegister = async () => {
  ...
  if (success) {
    ...
    fieldErrors.value =
      authStore.error?.fields || parseApiErrorFields(authStore.error?.details || authStore.error);
  }
};
</script>
